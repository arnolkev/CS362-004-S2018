...
Description: Random tests for the adventurer card
*/
...
#define RANDOMTEST "adventurerCard"
...
int main(int argc, char **argv)
{
    ...
    for (i = 0; i < iterations; i++)
    {
        ...
        // Not testing 0 because 0 is not playing adventurer - it is testing playCard instead
        ...
        if (discard_deck_treasures > 0)
        {
            ...
            // Hand size should be original handSize plus the number of treasures drawn minus one (the discarded card)
            if (handCount + discard_deck_treasures - 1 != state.handCount[0])
            {
                printf("%d - ERROR: wrong number of treasure cards drawn to hand\n", i + 1);
            }
            ...
            // Come back to coins
            if (discard_deck_treasures == 1)
            {
                if (state.hand[0][state.handCount[0] - 1] == copper && state.hand[0][state.handCount[0] - 1] == silver && state.hand[0][state.handCount[0] - 1] == gold)
                {
                    printf("%d - ERROR: drawn card is not a treasure card\n", i + 1);
                }

                if (state.hand[0][handCount] == copper)
                {
                    coins += 1;
                }
                else if (state.hand[0][handCount] == silver)
                {
                    coins += 2;
                }
                else if (state.hand[0][handCount] == gold)
                {
                    coins += 3;
                }
                ...
                {
                    printf("%d - ERROR: coins not correctly updated\n", i + 1);
                }
            }
            ...
            if (discard_deck_treasures == 2)
            {
                ...
                if (state.hand[0][handCount + 1] == copper)
                {
                    coins += 1;
                }
                else if (state.hand[0][handCount + 1] == silver)
                {
                    coins += 2;
                }
                else if (state.hand[0][handCount + 1] == gold)
                {
                    coins += 3;
                }
        ...
        {
            printf("%d - ERROR: crashing bug encountered - adventurer card played when total number of treasures in deck and discard = 0\n", i + 1);
        }
    }
